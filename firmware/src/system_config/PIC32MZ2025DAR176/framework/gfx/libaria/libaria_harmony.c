...
GFX_Result SQIInterface_externalMediaOpen(GFXU_AssetHeader* asset);
...
void SQIInterface_externalMediaClose(GFXU_AssetHeader* asset);
...
static GFX_Result LibAria_MediaOpenRequest(GFXU_AssetHeader* asset)
{
    return SQIInterface_externalMediaOpen(asset);
}
...
static GFX_Result LibAria_MediaReadRequest(GFXU_ExternalAssetReader* reader,
                                           ...
                                           GFXU_MediaReadRequestCallback_FnPtr cb)
{
    return SQIInterface_externalMediaRead(reader, asset, address, readSize, destBuffer, cb);
}

static void LibAria_MediaCloseRequest(GFXU_AssetHeader* asset)
{
    SQIInterface_externalMediaClose(asset);
}
