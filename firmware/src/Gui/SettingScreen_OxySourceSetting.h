/** @file SettingScreen_OxySourceSetting.h
 *  @brief The interfaces for display oxy source setting
 *  @author Trac Truong
 */

#ifndef SETTINGSCREEN_OXYSOURCCESETTING_H
#define	SETTINGSCREEN_OXYSOURCCESETTING_H
...
/** @brief SettingScreen_OxySourceSetting_Display
...
/** @brief SettingScreen_OxySourceSetting_SetCallbackFunction
...
/** @brief SettingScreen_OxySourceSetting_SetSetting
 *      This function is use to set setting
 *  @param [in] E_OxygenSource s
 *  @param [out] None
 *  @return None
 */
void SettingScreen_OxySourceSetting_SetSetting(E_OxygenSource s);

/** @brief SettingScreen_OxySourceSetting_GetSetting
 *      This function is use to get setting
 *  @param [in] None
 *  @param [out] None
 *  @return E_OxygenSource
 */
E_OxygenSource SettingScreen_OxySourceSetting_GetSetting();

/** @brief SettingScreen_OxySourceSetting_CheckDataChange
...
/** @brief SettingScreen_OxySourceSetting_SaveSetting
...
/** @brief SettingScreen_OxySourceSetting_DiscardSetting
