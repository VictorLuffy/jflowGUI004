...
static inline void DRV_TMR4_DeInitialize(void)
{
	DRV_TMR4_Stop();
}
static inline SYS_STATUS DRV_TMR4_Status(void)
{
	/* Return the status as ready always */
    return SYS_STATUS_READY; 
}
static inline void DRV_TMR4_Open(void) {}
DRV_TMR_CLIENT_STATUS DRV_TMR4_ClientStatus ( void );
static inline DRV_TMR_OPERATION_MODE DRV_TMR4_OperationModeGet(void)
{
    return DRV_TMR_OPERATION_MODE_16_BIT;
}
static inline void DRV_TMR4_Close(void) 
{
    DRV_TMR4_Stop();
}
...
static inline void DRV_TMR4_Tasks(void) {}
...
static inline void DRV_TMR5_Tasks(void) {}
...
static inline void DRV_TMR6_DeInitialize(void)
{
	DRV_TMR6_Stop();
}
static inline SYS_STATUS DRV_TMR6_Status(void)
{
	/* Return the status as ready always */
    return SYS_STATUS_READY; 
}
static inline void DRV_TMR6_Open(void) {}
DRV_TMR_CLIENT_STATUS DRV_TMR6_ClientStatus ( void );
static inline DRV_TMR_OPERATION_MODE DRV_TMR6_OperationModeGet(void)
{
    return DRV_TMR_OPERATION_MODE_16_BIT;
}
static inline void DRV_TMR6_Close(void) 
{
    DRV_TMR6_Stop();
}
...
static inline void DRV_TMR6_Tasks(void) {}
...
static inline void DRV_TMR7_DeInitialize(void)
{
	DRV_TMR7_Stop();
}
static inline SYS_STATUS DRV_TMR7_Status(void)
{
	/* Return the status as ready always */
    return SYS_STATUS_READY; 
}
static inline void DRV_TMR7_Open(void) {}
DRV_TMR_CLIENT_STATUS DRV_TMR7_ClientStatus ( void );
static inline DRV_TMR_OPERATION_MODE DRV_TMR7_OperationModeGet(void)
{
    return DRV_TMR_OPERATION_MODE_16_BIT;
}
static inline void DRV_TMR7_Close(void) 
{
    DRV_TMR7_Stop();
}
...
static inline void DRV_TMR7_Tasks(void) {}
