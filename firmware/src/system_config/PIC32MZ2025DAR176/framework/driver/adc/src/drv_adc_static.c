...
/* Setting for class-2 analog inputs */
    ...
    PLIB_ADCHS_AnalogInputDataReadyInterruptEnable(DRV_ADC_ID_1, ADCHS_AN18);
     PLIB_ADCHS_AnalogInputScanSetup
     (
          DRV_ADC_ID_1, 
          ADCHS_AN18, 
    ...
    PLIB_ADCHS_AnalogInputDataReadyInterruptEnable(DRV_ADC_ID_1, ADCHS_AN20);
     PLIB_ADCHS_AnalogInputScanSetup
     (
          DRV_ADC_ID_1, 
          ADCHS_AN20, 
    ...
    PLIB_ADCHS_AnalogInputDataReadyInterruptEnable(DRV_ADC_ID_1, ADCHS_AN21);
     PLIB_ADCHS_AnalogInputScanSetup
     (
          DRV_ADC_ID_1, 
          ADCHS_AN21, 
    ...
    PLIB_ADCHS_AnalogInputDataReadyInterruptEnable(DRV_ADC_ID_1, ADCHS_AN24);
     PLIB_ADCHS_AnalogInputScanSetup
     (
          DRV_ADC_ID_1, 
          ADCHS_AN24, 
    ...
    PLIB_ADCHS_AnalogInputDataReadyInterruptEnable(DRV_ADC_ID_1, ADCHS_AN33);
     PLIB_ADCHS_AnalogInputScanSetup
     (
          DRV_ADC_ID_1, 
          ADCHS_AN33, 
    ...
    PLIB_INT_VectorPrioritySet(INT_ID_0, INT_VECTOR_ADC1, INT_PRIORITY_LEVEL1);
...
inline void DRV_ADC_DigitalFilter2_Open(void)
{
...
inline void DRV_ADC_DigitalFilter2_Close(void)
{
...
inline bool DRV_ADC_DigitalFilter2_DataIsReady(void)
{
...
inline int16_t DRV_ADC_DigitalFilter2_DataRead(void)
{
...
inline void DRV_ADC_DigitalFilter3_Open(void)
{
     /* Enable digital comparator */
     PLIB_ADCHS_DigitalFilterEnable
     (
...
inline void DRV_ADC_DigitalFilter3_Close(void)
{
     /* Disable digital comparator */
     PLIB_ADCHS_DigitalFilterDisable
     (
...
inline bool DRV_ADC_DigitalFilter3_DataIsReady(void)
{
...
inline int16_t DRV_ADC_DigitalFilter3_DataRead(void)
{
