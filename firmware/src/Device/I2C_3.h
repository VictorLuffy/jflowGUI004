...
#ifndef _I2C_3_H    /* Guard against multiple inclusion */
#define _I2C_3_H
...
extern "C" {
    ...
    /** @brief Function to initialize I2C3, used to read data from Air Flow Sensor 
     ...
     */
    bool I2C3_Write(uint16_t address,
            void *writeBuffer,
            size_t size,
            uint32_t maxWait);
     ...
     */
    bool I2C3_Read(uint16_t address,
            void *readBuffer,
            size_t size,
            uint32_t maxWait);
