...
#ifndef _I2C_1_H    /* Guard against multiple inclusion */
#define _I2C_1_H
...
extern "C" {
    ...
    /** @brief Function to initialize I2C1, used to read data from Air Flow Sensor 
     ...
     */
    bool I2C1_Write(uint16_t address,
            void *writeBuffer,
            size_t size,
            uint32_t maxWait);
     ...
     */
    bool I2C1_Read(uint16_t address,
            void *readBuffer,
            size_t size,
            uint32_t maxWait);
