...
#define JFLO_BUTTON_WIDGET_ENABLED          1
#define JFLO_RECTANGLE_WIDGET_ENABLED       1  
#define JFLO_LABEL_WIDGET_ENABLED           1
#define JFLO_LINE_GRAPH_WIDGET_ENABLED      1

#define JFLO_CUSTOMWIDGET           1    
