...
{
//    static uint32_t TotalMallocSize = 0;
//    TotalMallocSize += size;
//    SYS_PRINT("alloc %d total %d \n", size, TotalMallocSize);
//    DisplayControl_PrintHex("\n TotalMallocSize = ", TotalMallocSize);
...
{
    if (offset) {
        return (void *)((long)offset | 0x80000000);
    }
    else {
        return NULL;
    }
