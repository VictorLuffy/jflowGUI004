...
//#define DEBUG_PRINT_DEV_INFO

#ifdef DEBUG_PRINT_DEV_INFO
...
//    int j;
//    SYS_PRINT("\n");
//    for(j = 0; j < sizeof(DeviceInformation) + CRC_SIZE_BYTES; j++)
//    {
//        SYS_PRINT(" %x ", data[j]);
//    }
//    SYS_PRINT("\n");
...
//    }
    ...
    SYS_PRINT("\nReturn Value Information restore: [%d]", ret);
    return ret;
//    return false;
}
...
void DeviceInformation_SetDefault(void )
{
    ...
    strcpy(devInfo.mainSerialNo, "JFL210401-001");
    strcpy(devInfo.mainTotalRuntime, "00");
    strcpy(devInfo.mainSWVer, "0.6.0");
    strcpy(devInfo.mainBootloaderVer, "0.1.0");
    strcpy(devInfo.subSWVer, "0.1.0");
    strcpy(devInfo.subBootloaderVer, "0.1.0");
    
    strcpy(devInfo.chamberSerialNo, "JFH210401-001");
    strcpy(devInfo.chamberTotalRuntime, "00");
    strcpy(devInfo.chamberSWVer, "0.1.0");
    strcpy(devInfo.chamberBootloaderVer, "0.0.3");
    
    strcpy(devInfo.cradleSerialNo, "JFC210401-001");
    strcpy(devInfo.cradleTotalRuntime, "00");
    strcpy(devInfo.cradleSWVer, "0.1.0");
    strcpy(devInfo.cradleBootloaderVer, "0.0.2");
    
    strcpy(devInfo.circuitSerialNo, "JFC210400-001");
...
bool DeviceInformation_SetDeviceInfo(E_DeviceInfoId id, char *str)
{
    if (str == 0)
        return false;
    SYS_PRINT("set info ID: %d, contend: %s\n", id, str);
    if(s_deviceInfoMutex == NULL)
    {
        SYS_PRINT("Error: deviceInfoMutex is null \n");
        return false;
