...
void SYS_PORTS_Initialize(void)
{
    ...
    /* PPS Input Remapping */
    PLIB_PORTS_RemapInput(PORTS_ID_0, INPUT_FUNC_U4RX, INPUT_PIN_RPC2 );
    ...
    PLIB_PORTS_RemapInput(PORTS_ID_0, INPUT_FUNC_SDI3, INPUT_PIN_RPB5 );
    PLIB_PORTS_RemapInput(PORTS_ID_0, INPUT_FUNC_IC8, INPUT_PIN_RPB1 );
    PLIB_PORTS_RemapInput(PORTS_ID_0, INPUT_FUNC_U6RX, INPUT_PIN_RPF3 );
    PLIB_PORTS_RemapInput(PORTS_ID_0, INPUT_FUNC_U1RX, INPUT_PIN_RPD14 );

    /* PPS Output Remapping */
    PLIB_PORTS_RemapOutput(PORTS_ID_0, OUTPUT_FUNC_U4TX, OUTPUT_PIN_RPC3 );
    PLIB_PORTS_RemapOutput(PORTS_ID_0, OUTPUT_FUNC_OC6, OUTPUT_PIN_RPD6 );
    PLIB_PORTS_RemapOutput(PORTS_ID_0, OUTPUT_FUNC_OC1, OUTPUT_PIN_RPG9 );
    PLIB_PORTS_RemapOutput(PORTS_ID_0, OUTPUT_FUNC_OC2, OUTPUT_PIN_RPE8 );
    PLIB_PORTS_RemapOutput(PORTS_ID_0, OUTPUT_FUNC_U2TX, OUTPUT_PIN_RPD0 );
    PLIB_PORTS_RemapOutput(PORTS_ID_0, OUTPUT_FUNC_U6TX, OUTPUT_PIN_RPD4 );
    PLIB_PORTS_RemapOutput(PORTS_ID_0, OUTPUT_FUNC_SDO3, OUTPUT_PIN_RPB10 );
    PLIB_PORTS_RemapOutput(PORTS_ID_0, OUTPUT_FUNC_OC8, OUTPUT_PIN_RPE3 );
    PLIB_PORTS_RemapOutput(PORTS_ID_0, OUTPUT_FUNC_SS6, OUTPUT_PIN_RPB9 );
    PLIB_PORTS_RemapOutput(PORTS_ID_0, OUTPUT_FUNC_SDO6, OUTPUT_PIN_RPB0 );
