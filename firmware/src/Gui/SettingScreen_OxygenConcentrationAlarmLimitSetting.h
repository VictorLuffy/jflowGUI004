/** @file SettingScreen_OxygenConcentrationAlarmLimitSetting.h
 *  @brief The interfaces for display oxygen concentration alarm limit setting
 *  @author Trac Truong
 */

#ifndef SETTINGSCREEN_OXYGENCONCENTRATIONALARMLIMITSETTING_H
#define	SETTINGSCREEN_OXYGENCONCENTRATIONALARMLIMITSETTING_H
...
/** @brief SettingScreen_OxygenConcentrationAlarmLimitSetting_Display
...
/** @brief SettingScreen_OxygenConcentrationAlarmLimitSetting_SetCallbackFunction
...
/** @brief SettingScreen_OxygenConcentrationAlarmLimitSetting_LowerInc
...
/** @brief SettingScreen_OxygenConcentrationAlarmLimitSetting_LowerDec
...
/** @brief SettingScreen_OxygenConcentrationAlarmLimitSetting_UpperInc
 *      This function is switch next language setting
 *  @param [in] None
 *  @param [out] None
 *  @return None
...
/** @brief SettingScreen_OxygenConcentrationAlarmLimitSetting_UpperDec
 *      This function is switch previous language setting
 *  @param [in] None
 *  @param [out] None
 *  @return None
...
/** @brief SettingScreen_OxygenConcentrationAlarmLimitSetting_SetLowerSetting
...
/** @brief SettingScreen_OxygenConcentrationAlarmLimitSetting_GetLowerSetting
...
/** @brief SettingScreen_OxygenConcentrationAlarmLimitSetting_SetUpperSetting
 *      This function is use to set setting
 *  @param [in] int s
 *  @param [out] None
 *  @return None
...
/** @brief SettingScreen_OxygenConcentrationAlarmLimitSetting_GetUpperSetting
 *      This function is use to get setting
 *  @param [in] None
 *  @param [out] None
 *  @return int
...
/** @brief SettingScreen_OxygenConcentrationAlarmLimitSetting_CheckDataChange
...
/** @brief SettingScreen_OxygenConcentrationAlarmLimitSetting_SaveSetting
...
/** @brief SettingScreen_OxygenConcentrationAlarmLimitSetting_DiscardSetting
