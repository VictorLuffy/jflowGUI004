/** @file SettingScreen_LanguageSetting.h
 *  @brief The interfaces for display language setting
 *  @author Trac Truong
 */

#ifndef SETTINGSCREEN_LANGUAGESETTING_H
#define	SETTINGSCREEN_LANGUAGESETTING_H
...
#include <stdlib.h>
    ...
    #define string_text_SettingScreen_Menu_Language_Japanese 0
    #define string_text_SettingScreen_Menu_Language_English 1
    #define string_text_SettingScreen_Menu_Language_Vietnamese 2
...
/** @brief SettingScreen_LanguageSetting_Display
...
/** @brief SettingScreen_LanguageSetting_SetCallbackFunction
...
/** @brief SettingScreen_LanguageSetting_NextSetting
...
/** @brief SettingScreen_LanguageSetting_PrevSetting
...
/** @brief SettingScreen_LanguageSetting_SetSetting
 *      This function is use to set setting
 *  @param [in] E_Language s
 *  @param [out] None
 *  @return None
 */
void SettingScreen_LanguageSetting_SetSetting(E_Language s);

/** @brief SettingScreen_LanguageSetting_GetSetting
...
/** @brief SettingScreen_LanguageSetting_CheckDataChange
...
/** @brief SettingScreen_LanguageSetting_SaveSetting
...
/** @brief SettingScreen_LanguageSetting_DiscardSetting
