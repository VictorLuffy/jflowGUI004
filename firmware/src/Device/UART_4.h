...
#ifndef _UART_4_H    /* Guard against multiple inclusion */
#define _UART_4_H
...
extern "C" {
     ...
     * The data to send will not immediately put on UART4 port, it will store on Uart4 TxBuffer
     * queue. Data on that Uart4 TxBuffer queue will be put serially first in first out
