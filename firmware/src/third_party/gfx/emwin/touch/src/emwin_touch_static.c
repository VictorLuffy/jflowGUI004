...
void emWin_TouchInitialize()
{
    ...
    emWinTouchData.orientation = EMWIN_TOUCH_ORIENTATION_JFLOW_MINI_DEGREE; //EMWIN_TOUCH_ORIENTATION_0_DEGREE;
...
void touchDownHandler_emwin(const SYS_INP_TouchStateEvent * const evt)
{
    ...
    case EMWIN_TOUCH_ORIENTATION_JFLOW_MINI_DEGREE:
        pidState->x = 272 - evt->y;
        pidState->y = evt->x;
        break;
    default:
        break;
